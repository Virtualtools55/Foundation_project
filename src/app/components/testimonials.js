export default function TestiMonials(){
  ...
  <div class="absolute inset-x-0 top-1/2 -z-10 -translate-y-1/2 transform-gpu overflow-hidden opacity-30 blur-3xl" aria-hidden="true">
    <div class="ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] " ></div>
  </div>
  <div class="absolute inset-x-0 top-0 -z-10 flex transform-gpu overflow-hidden pt-32 opacity-25 blur-3xl sm:pt-40 xl:justify-end" aria-hidden="true">
    <div class="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg]  xl:ml-0 xl:mr-[calc(50%-12rem)]"></div>
  </div>
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-xl text-center">
   
      <p class="mt-2 leading-8 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">We solved our problems with you</p>
    </div>
      ...
      <div class="space-y-8 xl:contents xl:space-y-0 shadow-2xl">
        ...
        <div class="space-y-8 xl:row-start-1 shadow-2xl">
          <figure class="rounded-2xl bg-white p-6  ring-1 ring-gray-900/5">
            ...
            <figcaption class="mt-6 flex items-center gap-x-4">
              {/* <img class="h-10 w-10 rounded-full bg-gray-50" src="data" alt=""> */}
              <div>
